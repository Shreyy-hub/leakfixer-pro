...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Artha" },
      { name: "description", content: "Description and Information" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Artha" },
      { property: "og:description", content: "Description and Information" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Artha" },
      { name: "twitter:description", content: "Description and Information" },
