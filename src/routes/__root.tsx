...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Artha Revenue — Lead Conversion for Med Spas" },
      { name: "description", content: "Performance-based lead conversion for med spas. Turn existing inquiries into booked appointments — you only pay when it works." },
      { name: "author", content: "Artha Revenue" },
      { property: "og:title", content: "Artha Revenue — Lead Conversion for Med Spas" },
      { property: "og:description", content: "Performance-based lead conversion for med spas. Turn existing inquiries into booked appointments — you only pay when it works." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Artha Revenue" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Artha Revenue — Lead Conversion for Med Spas" },
